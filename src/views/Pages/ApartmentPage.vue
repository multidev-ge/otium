...
<template>
  <mainLayout>
    <!-- Apartment Page -->
    <div
      class="flex flex-col max-md:px-4 md:mx-auto mt-1 sm:max-2xl:mt-2 2xl:mt-4 mb-56 sm:max-2xl:mb-48 2xl:mb-40">
      <div class="flex flex-row justify-start">
        <router-link class="flex items-center gap-x-1.5 px-3 py-6 rounded-2xl font-medium leading-8"
      ...
      <apartment-section class="xl:mt-7" />
