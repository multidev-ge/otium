...
<template>
  <div class="flex justify-center gap-8  pb-14">
    ...
    <div class="w-[415px]">
      <h3 class="font-medium text-2xl pr-20">
  ...
  <div class="flex gap-8	 justify-center ">
    ...
    <p class="w-[640px] text-xl	font-medium	leading-8	  text-[#00000099]">{{ BrandStory[0].BrandStoryDescription.description1 }}</p>
  </div>
