                  ...
                  <div class="md:w-2/6 flex flex-col md:items-start">
                    ...
                    <div class="gap-7 flex flex-col mb-6 ">
                      ...
                      <div class="flex md:flex-col justify-between gap-7">
                        <ProjectInfo :icon="HomeIcon" icon-name="Apartments for sale"
                          :value="project?.apartments_left + ' apartments left'" />
                        <ProjectInfo :icon="StatusIcon" icon-name="Status" :value="project?.status" />
                      </div>
                    </div>
                    <router-link :to="{ name: 'project', params: { id: project?.id } }"
                      class="bg-[#F0EEEC] flex items-center gap-3 px-6 py-3 justify-center  rounded-2xl mb-7 ">More About
                      Project <right-arrow /></router-link>
                  </div>
