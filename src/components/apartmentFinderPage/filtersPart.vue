...
<template>
  <div class="md:w-1/6 w-11/12 md:mx-0 mx-auto flex flex-col font-medium  gap-10">
    <p class="text-5xl ">Find your apartment</p>
    ...
    <div class="flex flex-col gap-3" >
      ...
      <div class="flex gap-2">
        <div class="text-lg flex items-center border-black cursor-pointer justify-center border w-10	h-10 rounded-md" @click="selectRoom(index+1)"  v-for="(index) in rooms.quantity"><p>{{index+1}}</p></div>
      </div>
    </div>
