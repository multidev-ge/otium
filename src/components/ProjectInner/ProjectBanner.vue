...
<template>
  <div class="relative">
    <img class="w-full h-[353px] md:h-full rounded-xl" src="@/assets/images/projectBanner/plan.png">
  ...
  <button @click="openPopup" class="block lg:hidden w-full py-3 mt-5 text-[16px] leading-[24px]  px-6 bg-[#F0EEEC] rounded-2xl font-medium">
    Choose a floor
