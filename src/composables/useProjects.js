...
export default function useProjects() {
  ...
  const flats = computed(() => store.getters['flats/flats'])
  ...
  const getProjects = async () => await store.dispatch('flats/getProjects')
  const getProject = async (...args) => await store.dispatch('flats/getProject', ...args)
  const getBlocks = async () => await store.dispatch('flats/getBlocks')
  const getFloors = async () => await store.dispatch('flats/getFloors')
