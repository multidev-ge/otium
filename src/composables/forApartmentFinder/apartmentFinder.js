...
export default (function useHome () {
    ...
    const doubleSliderOptions = ref({
        ...
        price:{maxValue:doubleSliderDefaultValues.value.price.maxValue, minValue:doubleSliderDefaultValues.value.price.minValue, name:"Price", prefix:"$"}
    })
    const getFloors = () =>{
        let floorArray = []
    ...
    const apartments = ref([
            {id:1, img:"https://i.imgur.com/LSaaUub.png", floor:2, area: 110, rooms: 3, isSold:true},
            {id:2, img:"https://i.imgur.com/LSaaUub.png", floor:3, area: 320, rooms: 2, isSold:false},
            {id:3, img:"https://i.imgur.com/LSaaUub.png", floor:4, area: 120, rooms: 1, isSold:true},
            {id:4, img:"https://i.imgur.com/LSaaUub.png", floor:1, area: 20, rooms: 4, isSold:false},
            {id:5, img:"https://i.imgur.com/LSaaUub.png", floor:3, area: 120, rooms: 4, isSold:true},
            {id:6, img:"https://i.imgur.com/LSaaUub.png", floor:3, area: 120, rooms: 3, isSold:false},
            {id:7, img:"https://i.imgur.com/LSaaUub.png", floor:9, area: 120, rooms: 3, isSold:false},
        ]
    )
    const filterApartments = computed(() => {
        return apartments.value.filter(apartment => {
            ...
            return roomFilter && floorFilter && areaFilter;
        });
    })
    ...
    let instance = { updateValues, doubleSliderOptions,changeDropDownValue, dropDowns, rooms, maxFloors, apartmentComponents, filterApartments, selectRoom, selectFloor, clearFilter, defaultValueForDropdown}
